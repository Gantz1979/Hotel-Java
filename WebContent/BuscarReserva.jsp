        ...
        <div id="page-wrapper">
            ...
            <div class="col-lg-8 col-lg-offset-1">
                <div class="page-header">
                    <h2>Búsqueda de Reservas</h2>
                </div>
                
           

                <form id="FrmReserva" method="post" class="form-horizontal" action="empleado">
                    <div class="panel-group" id="steps">
                        <!-- Step 1 -->
                         <div class="panel panel-default" >
                            <div class="panel-heading" >
                                <h4 class="panel-title"><a data-toggle="collapse" data-parent="#steps" href="#stepDos">Búsqueda de Reservas</a></h4>
                            </div>
